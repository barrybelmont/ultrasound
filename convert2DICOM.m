function [dicom, original_data, header] = convert2DICOM(varargin)
if nargin == 1
    filename = varargin{1};
else
...
dicomwrite(uint8(permute(original_data,[1 2 4 3])),strcat(filename,'.dcm'));
dicom = dicomread(strcat(filename,'.dcm'));
end